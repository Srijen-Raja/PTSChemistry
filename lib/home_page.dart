      ...
      children: [
        CarouselSlider(
          items: imgList.map(
              ...
              child: InkWell(
                onTap: () async{
                  if(item=='images/course.jpg'){
                    final Uri url = Uri.parse(
                      'https://forms.gle/JmHxycatfpngZJYH7',
                    );
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () {
          if (course_data_lib.courseData.any(
...
class CoursesPageContent extends StatelessWidget {
  ...
  const CoursesPageContent({super.key, this.controller, this.coursesKey});
    ...
    return ListView(
      ...
      children: <Widget>[
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    "Register to my Free Crash Course",
        ...
        Wrap(
          ...
          runSpacing: 20.0,
          children:
              course_data_lib.courseData.map((course) {
                return CourseCard(
                  title: course.title,
        ...
        const Wrap(
          ...
          children: [
            ...
            CourseCard(
              ...
              description:
                  'Experience chemistry through interactive online tools, real-world examples, and engaging problem-solving sessions that make learning effective and fun.',
            ),
            CourseCard(
            ...
            CourseCard(
              ...
              description:
                  'Develop critical thinking and a deep understanding of core concepts that will prepare you for success in university-level courses.',
            ),
          ],
        ),
        SizedBox(height: 25),
